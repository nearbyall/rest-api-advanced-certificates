# rest-api-advanced-certificates
REST API advanced. Java lab march 2022
# REST API Advanced
...
Migrate existing [Spring application](https://github.com/nearbyall/rest-api-basics-certificates) from a previous module to a Spring Boot application.
